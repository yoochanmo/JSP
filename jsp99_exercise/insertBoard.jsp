...
try {
    ...
    if (request.getParameter("submit") != null) {
        ...
        String sql = "INSERT INTO board (bno, subject, content, writer) VALUES (" + bno + ", '" + subject + "', '" + content + "', '" + writer + "')";
    ...
    <div class="container" align="center">
        ...
        <form action="" method="post">
            <table class="table table-bordered table-dark table-hover">
                <tr>
                    <td width="20%">bno</td>
                    <td><input type="text" name="bno" class="form-control" size="30" value=""></td>
                </tr>
                <tr>
                    <td>subject</td>
            ...
            <input type="submit" class="btn btn-info mt-sm-2" name="submit" value="게시판등록"/>
