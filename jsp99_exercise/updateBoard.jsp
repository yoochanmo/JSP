...
try {
    ...
    if (request.getParameter("submit") != null) {
        ...
        String sql = "UPDATE board SET subject='" + subject + "', content='" + content + "', writer='" + writer + "' WHERE bno=" + bno;
...
<body>
    <div class="container" align="center">
        ...
        <form action="" method="post">
            ...
            <input type="submit" class="btn btn-info mt-sm-2" name="submit" value="게시판 수정"/>
